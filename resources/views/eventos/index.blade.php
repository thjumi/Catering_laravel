        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('eventos.index') }}" class="mb-4 flex items-center">
                        <label for="fecha" class="mr-2 text-gray-700 dark:text-gray-300">Filtrar por fecha:</label>
                        <input type="date" name="fecha" id="fecha" class="px-4 py-2 border rounded-lg dark:bg-gray-700 dark:text-gray-300">
